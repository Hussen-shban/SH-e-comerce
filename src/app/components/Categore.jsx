...
const Categore = () => {
    ...
    const { data: product = [], isLoading, isError } = useCategore()
                        ...
                        <div className="flex items-center justify-around gap-16 flex-wrap mt-16 w-full">
                            {filteredProducts.map((pro) => (
                                <div data-aos="fade-up"
                                    key={pro.id}
                                    className="text-white relative h-[300px] w-[250px] mb-24 max-sm:w-[85%] max-sm:h-[350px]">
                                    ...
                                    <div className="bg-[#111111] pro rounded-full absolute left-[50%] translate-x-[-50%] bottom-[-10%] w-[70px] h-[70px] flex items-center justify-center">
                                        <div className="bg-white cursor-pointer p-[10px] rounded-full">
                                            <CART1 />
                                        </div>
                                    </div>
